...
/* programa para encontar el numero mayor y menor*/
int a;
int b;
int c;
int d;
...
int main()
{//inicio
printf("programa para ordenar de mayor a menor\n");
scanf("%d",a);
scanf("%d",b);
scanf("%d",c);
scanf("%d",d);
                ...
                else
				{
                    ...
                    if (f>=a && f>=b && f>=c && f>=d && f>=e && f>=g && f>=h && f>=i && f>=j)
                   {
                    ...
                    else
					{
                           ...
                           if (g>=a && g>=b && g>=c && g>=d && g>=e && g>=f && g>=h && f>=i && f>=j)
                        {
	                         printf("el mayor es %d\n",g);
                       }
                       else
            ...
            else
			{
                ...
                else
				{
                    ...
                    else
					{
                        if (f<=a && f<=b && f<=c && f<=d && f<=e && f<=g && f<=h && f<=i && f<=j)
                        {
	                       printf("el menor es %d",f);
                        }
                        else
						{
                            if (g<=a && g<=b && g<=c && g<=d && g<=e && g<=f && g<=h && g<=i && g<=j)
                            {
	                            printf("el menor es %d",g);
                            }
                            else
							{
                                if (h<=a && h<=b && h<=c && h<=d && h<=e && h<=f && h<=g && h<=i && h<=j)
                                {
	                                printf("el menor es &d",h);
                                }
                                else
								{
                                    if (i<=a && i<=b && i<=c && i<=d && i<=e && i<=f && i<=g && i<=h && i<=j)
                                    {
	                                    printf("el menor es %d",i);
                                    }
                                    else
									{
                                        if (j<=a && j<=b && j<=c && j<=d && j<=e && j<=f && j<=g && j<=h && j<=i)
                                        {
	                                        printf("el menor es %d",j);
                                        }
	                                }
                                }
                            }
